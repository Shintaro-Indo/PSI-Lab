#参考リンク：http://www.yoheim.net/blog.php?q=20160201
#データベースから類似語を判定するソースコード
#実装例は上記リンク参照
#データベースの形（./wnjpn.db）がどうなっているか見たかったけどわからなかった
...
conn = sqlite3.connect("./wnjpn.db")　　#ここに入れたいデータベースを入れると類似語判定してくれる
